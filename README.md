...
| 🏷 Image Watermark | Add custom text watermark with position selection |
| 📊 Status Stream | Real-time progress logs with auto-scroll and error highlighting |
| 🔍 Format Detect | Batch scan folder and auto-classify files by format |

### 🚀 Quick Start

#### Download

Download the latest release from [Releases](https://github.com/2048895034qq/FormatMaster-EN/releases/tag/v1.1.0) page — no installation required, just double-click `格式大师.exe`.
...
| 🔍 格式检测 | 批量扫描文件夹，按格式自动分类 |

### 🚀 快速开始

#### 下载使用

从 [Releases](https://github.com/2048895034qq/FormatMaster-EN/releases/tag/v1.1.0) 页面下载最新版本，解压后双击 `格式大师.exe` 即可使用。
